# Depth from Defocus Camera Project
Project to use a trained DNN, camera and microfluidic lens to infer depth from two differently focused images.
...
5. [FlyCapture 2 SDK](https://www.flir.com/support-center/iis/machine-vision/downloads/spinnaker-sdk-flycapture-and-firmware-download/ )
...
```
Windows: dfd_dnn_cam ../dnn_cam_input.txt
Linux: ./dfd_dnn_cam ../dnn_cam_input.txt
```
