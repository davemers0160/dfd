...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    DTI_0<cont2u<128, dfd_res_33<128,128, con3<128,

    dlib::concat2<DTO_1, DTI_1,
    DTI_1<cont2u<256, dfd_res_33<256,256, con3<256,

    dlib::concat2<DTO_2, DTI_2,
    DTI_2<cont2u<512, dfd_res_33<512,512, con3<512, con2d<512,
...
/*
gorgon_capture<1> gc_01(256,256,3,3);
gorgon_capture<5> gc_02(128,128,3,3);
gorgon_capture<8> gc_03(128,256,3,3);
gorgon_capture<14> gc_04(256,256,3,3);
gorgon_capture<17> gc_05(256,512,3,3);
gorgon_capture<23> gc_06(512,512,3,3);
gorgon_capture<26> gc_07(512,1024,3,3);
gorgon_capture<32> gc_08(1024,1024,3,3);
gorgon_capture<35> gc_09(1024,512,3,3);
gorgon_capture<40> gc_10(512,512,3,3);
gorgon_capture<43> gc_11(512,256,3,3);
gorgon_capture<48> gc_12(256,256,3,3);
gorgon_capture<51> gc_13(256,128,3,3);
