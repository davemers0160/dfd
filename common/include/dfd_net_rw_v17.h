...
input -> cbp3_blk -> dfd_res_33 [DTO_1] ------------------------------------------> [DTI_1] cbp3_blk -> dfd_res_33 -> bn -> prelu -> con3(256) -> output
                           \                                                                   /
                          con2d                                                             cont2u
                             \                                                               /
                           cbp3_blk -> dfd_res_33 [DTO_2] ---------> [DTI_2] cbp3_blk -> dfd_res_33
                                             \                                  /
                                            con2d                            cont2u
                                               \                              /
                                                --> cbp3_blk -> dfd_res_33 --> 
...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
	con3<256, dlib::prelu<dlib::bn_con<dfd_res_33<128,128, cbp3_blk<128,

    dlib::concat2<DTO_1, DTI_1,
    DTI_1<cont2u<256, dfd_res_33<256,256,cbp3_blk<256,

    dlib::concat2<DTO_2, DTI_2,
    DTI_2<cont2u<512, dfd_res_33<512,512, cbp3_blk<512, con2d<512,
    
    DTO_2<dfd_res_33<256,256, cbp3_blk<256, con2d<256,
	
    DTO_1<dfd_res_33<128,128, cbp3_blk<128, dlib::input<std::array<dlib::matrix<uint16_t>, img_depth>
    >>>>>>>>>>>>>>>>>>>>>>>>>;
