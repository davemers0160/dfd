...
// block defintions
template <int N, typename SUBNET> using cbp3_blk = dlib::prelu<con3<N, SUBNET>>;
template <int N, typename SUBNET> using cbp5_blk = dlib::prelu<con5<N, SUBNET>>;

template <int N1, int N2, typename SUBNET> using dfd_block_33 = con3<N1, dlib::prelu<con3<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_35 = con3<N1, dlib::prelu<con5<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_37 = con3<N1, dlib::prelu<con7<N2, SUBNET>>>;

template <int N1, int N2, typename SUBNET> using dfd_block_53 = con5<N1, dlib::prelu<con3<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_55 = con5<N1, dlib::prelu<con5<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_57 = con5<N1, dlib::prelu<con7<N2, SUBNET>>>;

template <int N1, int N2, typename SUBNET> using dfd_block_73 = con7<N1, dlib::prelu<con3<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_75 = con7<N1, dlib::prelu<con5<N2, SUBNET>>>;
template <int N1, int N2, typename SUBNET> using dfd_block_77 = con7<N1, dlib::prelu<con7<N2, SUBNET>>>;
...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
	...
	dfd_res_33<256, 256,cbp3_blk<256,
    ...
    dfd_res_33<1024,1024,con2d<1024,
    
    dtago2<dfd_res_33<512,512,con2d<512,
	
    dtago1<dfd_res_33<256, 256,
