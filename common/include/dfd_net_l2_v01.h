...
/*
cbp3_blk => con3(N) -> bn -> prelu
dfd_block_NM => con3(M) -> bn -> prelu -> con3(N)

input [DFD_I] -> cbp3_blk -> dfd_block_33 [DTO_0] --------------> concat[DTO_0, DTOI_0] -> cbp3_blk -> dfd_block_33 -> bn -> prelu -> con3(256) -> output
                                 \                                  /
                                con2d -----> dfd_block_33 -----> cont2u [DTI_0]
...
// tag definitions
// ----------------------------------------------------------------------------------------
template <typename SUBNET> using DFD_I = dlib::add_tag_layer<199, SUBNET>;
...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    DTI_0<cont2u<256, dfd_res_33<512, 512, con2d<512,
	
    DTO_0<dfd_res_33<256, 256, cbp3_blk<256, 
    
    DFD_I<dlib::input_dfd_array<uint16_t, img_depth>>
    >>> >>>> > >>>>> >;
...
using adfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    DTI_0<cont2u<256, adfd_res_33<512, 512, con2d<512,
	
    DTO_0<adfd_res_33<256, 256, acbp3_blk<256, 
