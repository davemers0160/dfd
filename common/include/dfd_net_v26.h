...
// --------------------------------- Conv Filter Setup ------------------------------------
template <long num_filters, typename SUBNET> using con1d = dlib::con<num_filters, 1, 1, 2, 2, SUBNET>;
...
template <long num_filters, typename SUBNET> using con4d = dlib::con<num_filters, 4, 4, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using con5d = dlib::con<num_filters, 5, 5, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using con6d = dlib::con<num_filters, 6, 6, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using con7d = dlib::con<num_filters, 7, 7, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using con8d = dlib::con<num_filters, 8, 8, 2, 2, SUBNET>;
...
template <long num_filters, typename SUBNET> using cont1u = dlib::cont<num_filters, 1, 1, 2, 2, SUBNET>;
...
template <long num_filters, typename SUBNET> using cont6u = dlib::cont<num_filters, 6, 6, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using cont7u = dlib::cont<num_filters, 7, 7, 2, 2, SUBNET>;
template <long num_filters, typename SUBNET> using cont8u = dlib::cont<num_filters, 8, 8, 2, 2, SUBNET>;
...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    dtagi1<cont1u<256, dfd_res_33<512,512,cbp3_blk<512,

    dlib::concat2<dtago2, dtagi2,
    dtagi2<cont1u<512, dfd_res_33<1024,1024,con1d<1024,
    
    dtago2<dfd_res_33<512,512,con1d<512,
