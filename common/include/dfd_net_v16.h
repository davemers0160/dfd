...
input -> tag10-> cbp7_blk -> dfd_res_77 [dtago1] ----------------------> [dtagi1] cbp3_blk -> dfd_res_33 -> prelu -> bn_con -> con3(N) -> output
                                ...
                                con2d                                             cont2u
                                   \                                               /
                                 dfd_res_33 [dtago2] ---------------> [dtagi2] dfd_res_33
                                     \                                           /
                                    con2d                                     cont2u
                                       \                                       /
                                        -------------> dfd_res_33 ------------> 
...
template <int N1,int N2,typename SUBNET>
using dfd_res_77 = dlib::add_prev1<dfd_block_77<N1,N2, dlib::tag1<SUBNET>>>;
...
template <int N1, int N2, typename SUBNET> using adfd_block_55 = con5<N1, dlib::prelu<dlib::affine<con5<N2, SUBNET>>>>;
template <int N1, int N2, typename SUBNET> using adfd_block_77 = con7<N1, dlib::prelu<dlib::affine<con7<N2, SUBNET>>>>;

template <int N1,int N2,typename SUBNET>
using adfd_res_33 = dlib::add_prev1<adfd_block_33<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using adfd_res_55 = dlib::add_prev1<adfd_block_55<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using adfd_res_77 = dlib::add_prev1<adfd_block_77<N1,N2, dlib::tag1<SUBNET>>>;
...
using dfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    dtago1<dfd_res_77<256, 256, cbp7_blk<256, 
...
using adfd_net_type = dlib::loss_multiclass_log_per_pixel<
    ...
    dtago1<adfd_res_77<256, 256, acbp7_blk<256, 
