...
coc_plot = figure(plot_height=550, plot_width=1300, title="Quantized Circles of Confusion (CoC)")
...
coc_plot.title.align = "center"
coc_plot.title.text_font_size = "16px"
coc_plot.title.text_font_style = "bold"

coc_plot.xaxis.axis_label = "Range (m)"
coc_plot.xaxis.axis_label_text_font_size = "14px"
coc_plot.xaxis.axis_label_text_font_style = "bold"
coc_plot.xaxis.major_label_text_font_size = "14px"
coc_plot.xaxis.major_label_text_font_style = "bold"

coc_plot.yaxis.axis_label = "Pixel Radius (px)"
coc_plot.yaxis.axis_label_text_font_size = "14px"
coc_plot.yaxis.axis_label_text_font_style = "bold"
coc_plot.yaxis.major_label_text_font_size = "14px"
coc_plot.yaxis.major_label_text_font_style = "bold"

coc_plot.legend.label_text_font_size = "14px"
coc_plot.legend.label_text_font_style = "bold"
